...
| Area | Status | Roadmap |
|------|--------|---------|
| **Authentication** | ⚠️ **Partial.** Real accounts, scrypt-hashed passwords, httpOnly session cookies with CSRF, per-org memberships and invitations. Bearer keys remain for machine access. Still missing: MFA, SSO, email verification and self-serve recovery. | P3-T1 ✓, P3-T2 ✓, P3-T3, P3-T5 |
