  ...
  return {
    ...
    paths: {
      ...
      "/v1/guardian/agent-groups": {
        ...
        post: stub(["guardian"], "Create ops label", "guardianBearer", { "201": { description: "Created" } }),
      },
      "/v1/guardian/agent-groups/{id}/archive": { post: stub(["guardian"], "Archive ops label", "guardianBearer") },
      "/v1/guardian/agent-groups/{id}/assign": { post: stub(["guardian"], "Assign agents to ops label", "guardianBearer") },
      "/v1/guardian/agent-groups/{id}/freeze": { post: stub(["guardian"], "Freeze all labeled agents", "guardianBearer") },
      "/v1/guardian/agent-groups/{id}/unfreeze": { post: stub(["guardian"], "Unfreeze all labeled agents", "guardianBearer") },
      "/v1/guardian/agent-groups/{id}/fund": { post: stub(["guardian"], "Split stipend across labeled agents", "guardianBearer") },
      ...
      "/v1/guardian/shared-wallets": {
        ...
        post: stub(
          ["guardian"],
          "DEPRECATED — use POST /v1/guardian/budgets",
          "guardianBearer",
