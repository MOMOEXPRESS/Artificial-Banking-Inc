...
export function openApiDocument(baseUrl = "http://localhost:8787") {
  ...
  return {
    ...
    paths: {
      ...
      "/v1/guardian/agent-groups/{id}/freeze": { post: stub(["guardian"], "Freeze all group members", "guardianBearer") },
      "/v1/guardian/agent-groups/{id}/unfreeze": { post: stub(["guardian"], "Unfreeze all group members", "guardianBearer") },
      "/v1/guardian/agent-groups/{id}/fund": { post: stub(["guardian"], "Split stipend across group members", "guardianBearer") },
