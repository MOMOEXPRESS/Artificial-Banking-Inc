...
export function openApiDocument(baseUrl = "http://localhost:8787") {
  ...
  return {
    ...
    paths: {
      ...
      "/v1/demo/bootstrap": {
        post: stub(["platform"], "Create demo org", null, { "201": { description: "Created" } }),
      },

      "/v1/agent/budget": {
        get: stub(["agent"], "Agent stipend + daily remaining", "agentBearer"),
      },
      "/v1/agent/activity": { get: stub(["agent"], "Agent decision activity log", "agentBearer") },
      "/v1/agent/decisions/{intentId}": {
        get: stub(["agent"], "Lookup decision by intent id", "agentBearer"),
      },
      ...
      "/v1/agent/escrow/{id}/release": {
        post: stub(["agent"], "Release escrow to payee", "agentBearer"),
      },
      "/v1/agent/escrow/{id}/refund": {
        post: stub(["agent"], "Refund escrow to payer", "agentBearer"),
      },
      "/v1/agent/approvals/{id}": { get: stub(["agent"], "Poll parked approval", "agentBearer") },

      "/v1/guardian/org": {
        get: stub(["guardian"], "Org, agents, balances, settings", "guardianBearer"),
      },
      "/v1/guardian/agents": {
        get: stub(["guardian"], "List agents (roster)", "guardianBearer"),
        post: stub(["guardian"], "Create agent", "guardianBearer", {
      ...
      "/v1/guardian/agents/{id}/profile": {
        patch: stub(["guardian"], "Update agent profile JSON", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/archive": {
        post: stub(["guardian"], "Archive agent (non-spendable)", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/unarchive": {
        post: stub(["guardian"], "Restore archived agent + new key", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/rotate-key": {
        post: stub(["guardian"], "Rotate agent API key", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/revoke-key": {
        post: stub(["guardian"], "Revoke API key + session keys", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/analytics": {
        get: stub(["guardian"], "Per-agent spend analytics", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/freeze": {
        post: stub(["guardian"], "Freeze agent", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/unfreeze": {
        post: stub(["guardian"], "Unfreeze agent", "guardianBearer"),
      },
      "/v1/guardian/agents/{id}/session-keys": {
        post: stub(["guardian"], "Mint short-lived session key", "guardianBearer", {
          "201": { description: "Created" },
        }),
      },
      "/v1/guardian/agent-groups": {
        get: stub(["guardian"], "List ops labels (agent groups)", "guardianBearer"),
        post: stub(["guardian"], "Create ops label", "guardianBearer", {
          "201": { description: "Created" },
        }),
      },
      "/v1/guardian/agent-groups/{id}/archive": {
        post: stub(["guardian"], "Archive ops label", "guardianBearer"),
      },
      "/v1/guardian/agent-groups/{id}/assign": {
        post: stub(["guardian"], "Assign agents to ops label", "guardianBearer"),
      },
      "/v1/guardian/agent-groups/{id}/freeze": {
        post: stub(["guardian"], "Freeze all labeled agents", "guardianBearer"),
      },
      "/v1/guardian/agent-groups/{id}/unfreeze": {
        post: stub(["guardian"], "Unfreeze all labeled agents", "guardianBearer"),
      },
      "/v1/guardian/agent-groups/{id}/fund": {
        post: stub(["guardian"], "Split stipend across labeled agents", "guardianBearer"),
      },
      "/v1/guardian/session-keys": {
        get: stub(["guardian"], "List session keys", "guardianBearer"),
      },
      "/v1/guardian/session-keys/{id}/revoke": {
        post: stub(["guardian"], "Revoke session key", "guardianBearer"),
      },
      "/v1/guardian/freezes": {
        get: stub(["guardian"], "Freeze / key-rotation audit log", "guardianBearer"),
      },
      "/v1/guardian/runs": {
      ...
      "/v1/guardian/allocate": {
        post: stub(["guardian"], "Allocate stipend org→agent", "guardianBearer"),
      },
      "/v1/guardian/reclaim": {
        post: stub(["guardian"], "Reclaim stipend agent→org", "guardianBearer"),
      },
      "/v1/guardian/transfer": {
        post: stub(["guardian"], "Transfer stipend agent→agent", "guardianBearer"),
      },
      "/v1/guardian/freeze": { post: stub(["guardian"], "Freeze agent or org", "guardianBearer") },
      "/v1/guardian/unfreeze": {
        post: stub(["guardian"], "Unfreeze agent or org", "guardianBearer"),
      },
      "/v1/guardian/policy": {
      ...
      "/v1/guardian/policy/versions": {
        get: stub(["guardian"], "Policy version history", "guardianBearer"),
      },
      ...
      "/v1/guardian/policy/simulate": {
        post: stub(["guardian"], "Simulate proposed rules on history", "guardianBearer"),
      },
      "/v1/guardian/policy/templates": {
        get: stub(["guardian"], "List starter policy templates", "guardianBearer"),
      },
      ...
      "/v1/guardian/approvals/{id}/resolve": {
        post: stub(["guardian"], "Approve or deny parked payment", "guardianBearer"),
      },
      "/v1/guardian/activity": {
        get: stub(["guardian"], "Decision / audit log", "guardianBearer"),
      },
      ...
      "/v1/guardian/reconcile": {
        get: stub(["guardian"], "Reconciliation report", "guardianBearer"),
      },
      ...
      "/v1/guardian/merchant-gateway/onboard": {
        post: stub(["guardian"], "Create an x402 V2 seller profile", "guardianBearer"),
      },
      ...
      "/v1/guardian/summary": {
        get: stub(["guardian"], "Natural-language summary facts", "guardianBearer"),
      },
      ...
      "/v1/guardian/invoices/{id}/pay": {
        post: stub(["guardian"], "Mark invoice paid / settle", "guardianBearer"),
      },
      "/v1/guardian/invoices/{id}/void": {
        post: stub(["guardian"], "Void invoice", "guardianBearer"),
      },
      ...
      "/v1/guardian/payments/rails": {
        get: stub(["guardian"], "List settlement rails", "guardianBearer"),
      },
      "/v1/guardian/payments/recent": {
        get: stub(["guardian"], "Recent settled payments", "guardianBearer"),
      },
      ...
      "/v1/guardian/setup": {
        get: stub(["guardian"], "Environment / custody setup hints", "guardianBearer"),
      },
      ...
      "/v1/guardian/audit/export": {
        get: stub(["guardian"], "Audit export JSON or CSV", "guardianBearer"),
      },
      "/v1/guardian/compliance": {
        get: stub(["guardian"], "Compliance screener status", "guardianBearer"),
      },
      "/v1/guardian/observability": {
        get: stub(["guardian"], "Observability sink status", "guardianBearer"),
      },
      "/v1/guardian/merchants/{id}": {
        delete: stub(["guardian"], "Delete merchant", "guardianBearer"),
      },
      "/v1/guardian/wallets": {
        get: stub(["guardian"], "Multi-wallet registry (org/dept/agent/shared)", "guardianBearer"),
      },
      "/v1/guardian/wallets/move": {
        post: stub(["guardian"], "Unified treasury move (HITL above threshold)", "guardianBearer"),
      },
      "/v1/guardian/departments": {
        get: stub(["guardian"], "List department treasuries", "guardianBearer"),
        post: stub(["guardian"], "Create department treasury", "guardianBearer", {
          "201": { description: "Created" },
        }),
      },
      "/v1/guardian/shared-wallets": {
        get: stub(["guardian"], "List legacy shared pools (read/drain only)", "guardianBearer"),
        post: stub(["guardian"], "DEPRECATED — use POST /v1/guardian/budgets", "guardianBearer", {
          "410": { description: "Gone — create a budget instead" },
        }),
      },
      ...
      "/v1/guardian/treasury/deposit": {
        post: stub(["guardian"], "Deposit into org treasury", "guardianBearer"),
      },
      "/v1/guardian/treasury/withdraw": {
        post: stub(["guardian"], "Withdraw from org treasury", "guardianBearer"),
      },
      "/v1/guardian/treasury/cashflow": {
        get: stub(["guardian"], "Cash-flow series", "guardianBearer"),
      },
      "/v1/guardian/treasury/forecast": {
        get: stub(["guardian"], "Treasury runway forecast", "guardianBearer"),
      },
      "/v1/guardian/treasury/moves": {
        get: stub(["guardian"], "List treasury moves", "guardianBearer"),
      },
      ...
      "/v1/guardian/treasury/recovery": {
        get: stub(["guardian"], "Recovery log + vault address", "guardianBearer"),
      },
